...
[![Version](https://img.shields.io/badge/version-v3.2.0-brightgreen)](#开发)
...
- **最新版 Release**：[v3.2.0](https://github.com/dzcnice/clipvault/releases/tag/v3.2.0)（发版后生效）
- **Windows 安装包**：`dist/clipvault-3.2.0-setup.exe`（本地 `npm run build:win`）
