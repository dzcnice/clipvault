...
[![Version](https://img.shields.io/badge/version-v3.2.2-brightgreen)](#开发)
...
- **最新版 Release**：[v3.2.2](https://github.com/dzcnice/clipvault/releases/tag/v3.2.2)
- **Windows 安装包**：[`clipvault-3.2.2-setup.exe`](https://github.com/dzcnice/clipvault/releases/download/v3.2.2/clipvault-3.2.2-setup.exe)
